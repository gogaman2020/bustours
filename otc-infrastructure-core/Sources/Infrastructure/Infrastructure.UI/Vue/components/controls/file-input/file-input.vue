<template>
  <div :class="[style.customFileInput, style.customSmartFile] ">
    <label :for="'customFileLangHTML' + postfixId">{{ label_text }}</label>
    <button-blue :class="style.customFileInputButton">
        <label :for="'customFileLangHTML' + postfixId" :class="[style.customFileInputLabel]">Прикрепить документ</label>
    </button-blue>
